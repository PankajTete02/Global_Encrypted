...
exports.brochure = function (req, res) {
  const new_details = new brochure(req.body);

  brochure.create(new_details, function (err, details) {
    if (err) {
      console.log(err);
...
exports.findAll = function (req, res) {
  brochure.findAll(function (err, details) {
    if (err) {
      console.log(err);
      return res.status(400).json({
        status: false,
...
exports.find_searchby_brochure = function (req, res) {
  console.log('.................', req.body);
  brochure.find_searchby_brochure(req.body, function (err, data) {
    if (err) {
      res.send(err);
    } else {
...
exports.delete = function (req, res) {
  brochure.delete(req.body.brochure_id, function (err, role) {
